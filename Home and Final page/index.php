...
<body>
	<header class="header" id="header">
		...
		<div class="container">
			...
			</figure><h><b>TAMIL NADU POLICE</b></h>
			<h1 class="animated fadeInDown delay-07s">WELCOME TO TAMIL NADU TRAFFIC CONTROL</h1>
			<ul class="we-create animated fadeInUp delay-1s">
				<li>IF U BREAK THE RULE THEN <b>Adi tha ini  </b></li>
			</ul>
 ...
 <br></p>
	...
	<section class="main-section client-part" id="client">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<h4 style="font-style: italic; color: white;"> Hello there! My name is Dinesh S., and I’m the creator of this advanced Traffic Police Management website. This is a mini project that highlights my expertise in the field of Database Management Systems.</h4>
				</div>
			</div>
			<ul class="client wow fadeIn delay-05s">
				<li><a href="#">
            	<img src="./img/DINESH.jpg" height="250" width="250" alt="">
                <h3>DINESH S</h3>
            </a></li>
			</ul>
		</div>
		...
		<div class="container">
			...
			<div class="team-leader-block clearfix">
				<div class="team-leader-box">
					...
					<a href="https://www.instagram.com/_.rajesh.m_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">RAJESH M</a><h3 class="wow fadeInDown delay-03s"></h3>
					<span class="wow fadeInDown delay-03s">Superientendent of Police</span>
				</div>
				<div class="team-leader-box">
					<div class="team-leader  wow fadeInDown delay-06s">
						<div class="team-leader-shadow"><a href="#"></a></div>
						<img src="./img/Arun.jpg" width="300" height="300" alt="">
					</div>
					<a href="https://www.instagram.com/mr._.hawks_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">ARUN PRASATH R</a><h3 class="wow fadeInDown delay-03s"></h3>					<span class="wow fadeInDown delay-06s">Director General of Police</span>
				</div>
				<div class="team-leader-box">
					<div class="team-leader wow fadeInDown delay-09s">
						<div class="team-leader-shadow"><a href="#"></a></div>
						<img src="./img/Naren.jpg" width="300" height="300" alt="">
					</div>
					<a href="https://www.instagram.com/__sai_naren__?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">NARENDRAN R</a><h3 class="wow fadeInDown delay-03s"></h3>
			...
			<div class="row">
				<div class="col-lg-6 col-sm-7 wow fadeInLeft">
					<div class="contact-info-box address clearfix">
						...
						<span>RTO, Tambaram, Dharkast Rd, Near ARK Brothers, Tambaram West, Tambaram, Chennai, Tamil Nadu</span>
					</div>
					<div class="contact-info-box phone clearfix">
						<h3><i class="fa fa-phone"></i>Phone:</h3>
						<span>044 2226 7666</span>
					</div>
					<div class="contact-info-box email clearfix">
						<h3><i class="fa fa-pencil"></i>email:</h3>
						<span>dinesh.suresh2001@gmail.com</span>
					</div>
					<div class="contact-info-box hours clearfix">
						<h3><i class="fa fa-clock-o"></i>Hours:</h3>
						<span><strong>Monday - Thursday:</strong> 10am - 6pm<br><strong>Friday:</strong> People work on Fridays now?<br><strong>Saturday - Sunday:</strong> Only Important Cases</span>
					</div>
					<ul class="social-link">
						<li class="facebook"><a href="https://www.facebook.com/profile.php?id=100035080308499"><i class="fa fa-facebook"></i></a></li>
